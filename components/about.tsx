...
export default function About() {
  return (
    ...
    >
      ...
      <p className="mb-3">
        While in the process of graduating with a degree in{" "}
        ...
        is{" "}
        <span className="font-medium">React, Python, Node.js, and Next.js</span>
      ...
      <p>
        ...
        volleyball, watching movies, and playing with my dog. I also enjoy{" "}
        <span className="font-medium">learning new things</span>. I am currently
        learning about{" "}
        <span className="font-medium">
          how to create and edit entertaining media
        </span>
